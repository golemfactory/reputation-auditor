        ...
        if offer.accepted:
            try:
                ...
                try:
                    ...
                    benchmark_type = parts[1] if len(parts) > 1 else completion.task_name
                except IndexError:
                ...
                if completion.is_successful:
                    ...
                    task_entry.error_message = f"{benchmark_type.capitalize()} benchmark - {completion.error_message}"
